...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    const embed = new EmbedBuilder()
      .setTitle("Ordering")
      .setDescription(
        "You can purchase a product via our [Product Hub](https://dev.jxsou.lighting/store) or via [PayPal](https://paypal.me/josou10). You can try out our products via our [Testing Place](https://dev.jxsou.lighting/demo)."
      )
      .addFields([
        {
    ...
    const row = new ActionRowBuilder().addComponents(
      ...
      new ButtonBuilder()
        .setURL("https://dev.jxsou.lighting/roblox")
