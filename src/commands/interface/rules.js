...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    const termsEmbed = new EmbedBuilder()
      ...
      .setFooter({
        iconURL: client.user.displayAvatarURL(),
        text: "Last updated: 09/22/2022 - Subject to change anytime",
      });
    ...
    const linksEmbed = new EmbedBuilder()
      ...
      .addFields(
        {
          name: "Discord Server",
          value: "https://dev.jxsou.lighting/discord",
        },
        {
          name: "Product Hub",
          value: "https://dev.jxsou.lighting/store",
        },
        {
          name: "Roblox Group",
          value: "https://dev.jxsou.lighting/roblox",
        },
        {
          name: "PayPal",
