...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const ledBarsEmbed = new EmbedBuilder()
            ...
            .addFields({
                name: "Description",
                value: "The GLP Impression X4 Bar 20 is a powerful light that provides multiple lighting effects. The LED Bar has 20 LEDs, multiple types of colors, adjustable beam length and is able to tilt.",
            })
        ...
        const blindersEmbed = new EmbedBuilder()
            ...
            .addFields({
                name: "Description",
                value: "The Elation CUEPIX Blinder WW2 and WW4 fixtures are used to illuminate both big indoor or outdoor open spaces by using a high intensity light with controllable brightness.",
            })
        ...
        const magicPanelsEmbed = new EmbedBuilder()
            ...
            .addFields({
                name: "Description",
                value: "The Ayrton MagicPanel FX is comprised of a 5 x 5 array of squared lenses with adjustable beams that can do multiple effects for your events.",
            })
        ...
        const strobesEmbed = new EmbedBuilder()
            ...
            .addFields({
                name: "Description",
                value: "Jxsou's Lighting Strobes, with multiple types of colors and effects, are specifically designed for large stages, nightclubs and live events.",
            })
        ...
        const ledCubesEmbed = new EmbedBuilder()
            ...
            .addFields({
                name: "Description",
                value: "Jxsou's Lighting LED Cubes, perfectly designed to bring life to concerts, provide multiple lighting effects.",
            })
        ...
        const washesEmbed = new EmbedBuilder()
            ...
            .addFields({
                name: "Description",
                value: "Bring life to your stage with Jxsou's Lighting Washes which are perfect for evenly lighting up large areas like stages or nightclubs.",
            })
