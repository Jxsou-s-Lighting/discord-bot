...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    const welcomeEmbed = new EmbedBuilder()
      .addFields(
        {
          name: "Welcome to Jxsou's Lighting",
          value:
        ...
        },
        {
          name: "Purchases",
          value:
            "All of our products can be purchased via our [Product Hub](https://jxsou.lighting/hub) using robux and then be obtained using the /retrieve [Product] command. We also accept [PayPal](https://paypal.me/josou10) transactions. To order via PayPal, create an ordering ticket.",
        }
      )
    ...
    const rulesEmbed = new EmbedBuilder()
      ...
      .setImage("https://i.postimg.cc/KcLzSxNB/rules.png")
      .setFooter({
        iconURL: client.user.displayAvatarURL(),
